...
import { bindFormToExternalState, createField, createForm } from "./form-core";
import { state } from "../../packages/core/src/index";
...
describe("Form Research F1 — Minimal Field and Form State Prototype", () => {
  ...
  describe("Model Ownership Trade-Offs", () => {
    ...
    it("External State Binding: bidirectional synchronization with external store", () => {
      const appStore = state({ search: "query", page: 1 });
