...
describe("@vii-labs/form package boundary (P1b)", () => {
  test("root and adapter entrypoints resolve cleanly as zero-runtime ESM modules", () => {
    expect(formRoot).toBeDefined();
    expect(Object.keys(formRoot)).toEqual([]);
