...
- HTTP transport research and graduation decision: `docs/roadmap/HTTP_CLIENT_RESEARCH.md`, `docs/architecture/HTTP_CLIENT.md`, `docs/architecture/ADR_HTTP_GRADUATION_DECISION.md`, `research/http/README.md`;
